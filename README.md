...
For demonstration purposes, this repository recreates the project using a test dataset.

---

## Business Case
Non-profit organizations rely on donor retention to sustain their operations. Accurately predicting donor churn allows organizations to proactively engage at-risk donors and optimize fundraising efforts. This project evaluates multiple models to identify the best-performing approach for donor churn prediction.
